...
header("Access-Control-Allow-Origin: *");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR empty($message) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
            ...
            echo "Plotësoni formen dhe provoni perseri.";
            exit;
        }

        // Set the recipient email address.
        $recipient = "edikerciku@gmail.com";

        // Set the email subject.
        $subject = "Biz Advertising - Email From $name";
        ...
        $email_headers .= 'From:' . $name . ' ' . 'info@biz-advertising.al' . "\r\n";
        ...
        if (mail($recipient, $subject, $email_content, $email_headers)) {
            ...
            echo "Faleminderit! ".$name." , Mesazhi juaj u dergua.";
        } else {
